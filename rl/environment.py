# we are going to be instantiating the car racing environment
# We are using car-racing-v1

# libraries
import gym
from gym import envs
import numpy as np
from rl.helper_functions import rgb2gray, action_list, sel_action, sel_action_index
...
# creating the environment class itself
class environment:
    ...
    def run(self, agent):
        ...
        while True:
            ...
            if self.step % action_repeat_num == 0:
                ...
                # img_rgb[:,:,1] being the green values of the image
